...
namespace System.Management.Tests
{
	internal class ProviderProjectMaker : CodeWriterBase
	{
		...
		public ProviderProjectMaker (string basePath, bool isTest)
			: base(null)
		{
		...
		public override void Write ()
		{
			...
			WriteLine("    <ExtraLinkerArguments>-L/usr/local/lib/pegasus/lib -L/usr/local/lib -lpegcommon -lpegprovider -lpegclient -lpegslp_client -lpegquerycommon -lpegqueryexpression -lpegcql -lpegwql -lpegrepository -lutil -lgeom -ljail -lkvm -pthread -lcam -lpkg" + (isTest ? " -lUNIXProviders" : "") + "</ExtraLinkerArguments>");
			if (isTest)
			{
				WriteLine ("    <EnvironmentVariables>");
				WriteLine ("      <EnvironmentVariables>");
						WriteLine("        <Variable name=\"LD_LIBRARY_PATH\" value=\"../../../../bin/Debug:/usr/local/lib/pegasus/lib:/usr/local/lib:/usr/lib:/lib\" />");
							WriteLine("      </EnvironmentVariables>");
								WriteLine("    </EnvironmentVariables>");
